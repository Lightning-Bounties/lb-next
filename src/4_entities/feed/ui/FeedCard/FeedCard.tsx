                ...
                <Row gutter={[12, 12]} align="middle">
                    <Col md={18} xs={14} sm={14} className={s.owner}>
                        <Flex vertical gap="small">
                            <Flex>{renderRewarderAvatars()}</Flex>
                            <Flex align="center" gap="small">
                                <Link
                                    href={
                                        appRoutes.profile +
                                        '/' +
                                        props.last_rewarder_data?.id
                                    }
                                    rel="nofollow"
                                    onClick={handleLinkClick}
                                >
                                ...
                                {props.total_rewards > 1 ? (
                                    <Typography
                                        className={`opacity50 ${s.more}`}
                                    >
                                        + {props.total_rewards - 1} others
                                    </Typography>
                                ) : null}
                            </Flex>
