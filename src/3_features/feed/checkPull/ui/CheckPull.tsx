...
const CheckPull: FC<CheckPullProps> = ({ repoName, issueId }) => {
    ...
    const { mutateAsync: checkPull, isPending } = useMutation({
        mutationFn: feedApi.checkPull,
    });
    const { mutateAsync: claimReward, isPending: isPending2 } = useMutation({
        mutationFn: feedApi.claimReward,
    });
