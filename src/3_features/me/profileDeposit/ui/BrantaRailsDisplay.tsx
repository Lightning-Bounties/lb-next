...
const BrantaRailsDisplay: FC<BrantaRailsDisplayProps> = ({ invoice, onClick }) => {
    ...
    return (
        <div>
            ...
            <a target="_blank" href={`https://${process.env.NEXT_PUBLIC_DEV_MODE == 'true' ? 'staging' : 'payments'}.branta.pro/v1/verify/${invoice}`}>
